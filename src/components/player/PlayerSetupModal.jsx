...
export default function PlayerSetupModal({ open, onOpenChange, playerId, providerId, providerClientId, zoneId, deviceName }) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground text-center">Der Player verbindet Spotify direkt am Gerät. Zonen sind nur Räume; API und Musik laufen über den Player.</p>
        </div>
      </DialogContent>
    </Dialog>
  );
